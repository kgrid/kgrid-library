...
<title><spring:message code="LOAD_API_TITLE"/></title>
...
<body>
	...
	<div class="content-right">
		...
		<p>
			<spring:message code="LOAD_API_MESSAGE_1" />
		</p>
		&nbsp;&nbsp;&nbsp;&nbsp;

		<form method="POST" enctype="multipart/form-data"
		action="uploadFunctionDescriptor">
		<input type="file" name="file" class="w3-btn w3-dlol-teal"> 
		<input type="submit" value="Upload Function Description File" class="w3-btn w3-dlol-teal">
	</form>

		<sf:form class="w3-container" modelAttribute="fedoraObject" action="finalize" >
			<p>
				<br />  <label><spring:message code="LOAD_API_MESSAGE_2"/></label>
				<sf:textarea class="w3-input-long w3-border" path="functionDescriptor"></sf:textarea>
			</p>
