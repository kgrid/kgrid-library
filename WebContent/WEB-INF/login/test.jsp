           ...
           <table id="libsettable">
            <tr>
             ...
             <td class="rheader"><spring:message code="FIELD_LOGIN" /></td>
               ...
               <tr>
                <td class="cheader">   </td>
                <td class="cheader">  <input type="button" id="fedoratest" class="testbutton" onclick="testFedoraURL()" value="Test"> </input> </td>
                <td class="cheader">  <input type="button" id="fusekitest" class="testbutton" onclick="testFusekiURL()" value="Test"> </input>  </td>
                <td class="cheader">  <input type="button" id="SMTPtest" class="testbutton" onclick="testFusekiURL()" value="Test"> </input>  </td>
               </tr>
               <tr>
                <td class="cheader">  </td>
             ...
             <input type="button" id="saveaction" class="savebutton"  onclick="saveData()" value="Save Changes"> </input>  
            </form>
            </div> 
