...
<template>
  <div class="dropdown v-select" :class="dropdownClasses">
    <div ref="toggle" @mousedown.prevent="toggleDropdown" class="dropdown-toggle">
      ...
      <span id="stag" class="selected-tag" v-for="option in valueAsArray" v-bind:key="option.index">
  ...
  export default {
    ...
    methods: {
      ...
      toggleDropdown(e) {
        ...
        if (e.target === this.$refs.openIndicator || e.target === this.$refs.search || e.target === this.$refs.toggle || e.target.id === 'stag' || e.target === this.$el) {
          if (this.open) {
