...
public class KnowledgeObjectService {
	...
	public ProvenanceLogData getProvData(URI objectURI) throws ObjectTellerException, URISyntaxException {
	...
	private void addLicense(License license, URI objectURI) throws URISyntaxException, ObjectTellerException{
		if (license != null) {
