 ...
 *
 */
public class OTUser extends User {
	
	private UserProfile profile ; 
	
	public OTUser(String username, String password, Collection<? extends GrantedAuthority> authorities,
			UserProfile profile) {
	...
	public OTUser(String username, String password, boolean enabled, boolean accountNonExpired,
