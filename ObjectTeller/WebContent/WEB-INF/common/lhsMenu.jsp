	...
	<div class="content-left">
		<c:choose>
			<c:when test="${(ActiveTab == 'Objects') && (PageType == 'List')}">
				...
				<h3>
					<spring:message code="LHS_MENU_OBJECT_LIST_QUERY" />
					(${QueryObjects})<br />
					<spring:message code="LHS_MENU_OBJECT_LIST_RESULT" />
					(${ResultObjects})<br />
					<spring:message code="LHS_MENU_OBJECT_LIST_KNOWLEDGE" />
					(${KnowledgeObjects})<br />
					<spring:message code="LHS_MENU_OBJECT_LIST_TAILORING" />
					(${TailoringObjects})<br />
				</h3>
			</c:when>
				...
				<div id="navcontainerV">
					<ul id="navlistV">
						...
						<li id="${ActiveSubTab == 'Edit' ? 'activeV' : ''}"><a
							href="editAccount"><spring:message
									code="LHS_MENU_EDIT" /></a></li>
					</ul>
				</div>
			</c:when>
					...
					<ul id="navlistV">
						<li id="${ActiveSubTab == 'View' ? 'activeV' : ''}"><a
							href="viewSystemConf" id="current"><spring:message
									code="LHS_MENU_VIEW" /></a></li>
						<li id="${ActiveSubTab == 'Edit' ? 'activeV' : ''}"><a
							href="editSystemConf"><spring:message
									code="LHS_MENU_EDIT" /></a></li>
					</ul>
				</div>
			</c:when>
